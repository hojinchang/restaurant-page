const createHome = (() => {
    const createRestaurantDescription = () => {
        ...
        descriptionContainer.classList.add("home-container", "home-description");
    ...
    const createRestaurantHours = () => {
        ...
        hoursContainer.classList.add("home-container", "home-hours");
    ...
    const createLocation = () => {
        ...
        locationContainer.classList.add("home-container", "home-location");
